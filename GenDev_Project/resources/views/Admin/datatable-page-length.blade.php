        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Datatable length menu</h3>
                </div>
                <div class="card-body">
                    <p class="text-muted">
                        It is possible to easily customize the options shown in the length menu (by default at the top left
                        of the table) using the <code>lengthMenu</code> Initialisation option, this parameter can take
                        1D or 2D array.
                    </p>
                    <div class="">
