                                        ...
                                        <div class="row g-3">
                                            ...
                                            @if ($user->ward)
                                                <div class="col-md-6">
                                                    <div class="d-flex align-items-center mb-3">
                                                        <div class="flex-shrink-0">
                                                            <i class="fas fa-map-pin text-primary fa-fw"></i>
                                                        </div>
                                                        <div class="flex-grow-1 ms-3">
                                                            <h6 class="mb-0 text-muted">Phường/Xã</h6>
                                                            <p class="mb-0">{{ $user->ward }}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            @endif
                                            @if ($user->city)
                                                <div class="col-md-6">
                                                    <div class="d-flex align-items-center mb-3">
                                                        <div class="flex-shrink-0">
                                                            <i class="fas fa-building text-primary fa-fw"></i>
                                                        </div>
                                                        <div class="flex-grow-1 ms-3">
                                                            <h6 class="mb-0 text-muted">Thành phố/Tỉnh</h6>
                                            ...
                                            @if ($user->postcode)
                                                <div class="col-md-6">
                                                    <div class="d-flex align-items-center mb-3">
                                                        ...
                                                        <div class="flex-grow-1 ms-3">
                                                            <h6 class="mb-0 text-muted">Mã bưu điện</h6>
                                                            <p class="mb-0">{{ $user->postcode }}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            @endif
                                            <div class="col-md-6">
                                                <div class="d-flex align-items-center mb-3">
                                                    <div class="flex-shrink-0">
                                                        <i class="fas fa-check-double text-primary fa-fw"></i>
                                                    </div>
                                                    <div class="flex-grow-1 ms-3">
                                                        <h6 class="mb-0 text-muted">Email xác thực</h6>
                                                        <p class="mb-0">
                                            ...
                                            <div class="col-md-6">
                                                <div class="d-flex align-items-center mb-3">
                                                    <div class="flex-shrink-0">
                                                        <i class="fas fa-ban text-danger fa-fw"></i>
                                                    </div>
                                                    <div class="flex-grow-1 ms-3">
                                                        <h6 class="mb-0 text-muted">Trạng thái ban</h6>
                                                        <p class="mb-0">
                                                            @if ($user->is_banned)
                                                                ...
                                                                @endif
                                                            @else
                                                                <span class="badge bg-success">Không bị cấm</span>
                                                            @endif
                                                        </p>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="d-flex align-items-center mb-3">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        ...
                                                        <p class="mb-0">{{ $user->created_at->format('d/m/Y H:i:s') }}
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="d-flex align-items-center mb-3">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        ...
                                                        <p class="mb-0">{{ $user->updated_at->format('d/m/Y H:i:s') }}
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
