                        ...
                        <div class="card-addon">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated">
                                    ...
                                    <a class="dropdown-item" href="#"><span class="badge badge-label-info">Work</span>
                                    </a>
                                    <a class="dropdown-item" href="#"><span
                            ...
                            <div class="card"
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-5">
                                            <img src="{{ URL::asset('build/images/dashboard/upgarde-1.png') }}" alt=""
...
@section('content')
    <div class="container py-4">
        ...
        <div class="card mb-4">
            <div class="card-header bg-warning text-dark fw-semibold">🏆 Top 10 khách hàng</div>
            <div class="card-body"><canvas id="topUserChart" height="100"></canvas></div>
        </div>

        <div class="card mb-4">
            <div class="card-header bg-secondary text-white fw-semibold">🧩 Pie - Doanh thu theo khách hàng</div>
            <div class="card-body"><canvas id="pieCustomerChart" height="100"></canvas></div>
        </div>
    </div>
@endsection
    ...
    <script>
        ...
        new Chart(document.getElementById('topUserChart'), {
            ...
            options: {
                indexAxis: 'y',
                scales: {
                    x: { beginAtZero: true, ticks: { callback: formatCurrency } }
                }
            }
        });

        // Chart: Pie khách hàng
        new Chart(document.getElementById('pieCustomerChart'), {
            type: 'doughnut',
            data: {
                labels: {!! json_encode($topUsers->pluck('name')) !!},
                datasets: [{
                    data: {!! json_encode($topUsers->pluck('total_spent')) !!},
                    backgroundColor: ['#4e73df', '#1cc88a', '#36b9cc', '#f6c23e', '#e74a3b', '#858796', '#20c9a6', '#fd7e14', '#6f42c1', '#ff6384']
                }]
            },
            options: {
                plugins: {
