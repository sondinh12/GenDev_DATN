        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Footer datatable</h4>
                </div>
                <div class="card-body">
                    <p class="text-muted"><strong>Datatables</strong> has most features enabled by default with table
                        footer, so all you need to do to use it with your own tables is to call the construction function:
