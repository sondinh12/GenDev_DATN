        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Scroll datatable</h4>
                </div>
                <div class="card-body">
                    <p class="text-muted">
                        This example shows the DataTables table body scrolling in the sidebar direction. This can generally
                        be seen as an
                        alternative method to pagination for displaying a large table in a fairly small sidebar area, and as
                        such
