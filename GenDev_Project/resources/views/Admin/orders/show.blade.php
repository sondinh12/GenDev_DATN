        ...
        <div class="col-lg-10">
            <div class="card shadow mb-4">
                <div class="card-header bg-primary text-white d-flex align-items-center justify-content-between">
                    ...
                    <a href="{{ route('orders.index') }}" class="btn btn-light btn-sm"><i class="fas fa-arrow-left"></i> Quay lại</a>
                </div>
                <div class="card-body">
    ...
    <div class="col-md-6">
        ...
        @endif
                    ...
                    <div class="card mb-4 border-start border-4 border-info">
                        <div class="card-header bg-light fw-bold"><i class="fas fa-shipping-fast me-2"></i>Thông tin giao hàng</div>
                        <div class="card-body p-3">
                            <div class="row mb-2">
                            ...
                            <div class="row mb-2">
                                <div class="col-sm-4 fw-bold">Mã giảm giá:</div>
                                <div class="col-sm-8">{{ $order->coupon->coupon_code ?? '-' }}</div>
                            </div>
                        </div>
                    </div>
                                ...
                                <table class="table table-bordered mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="{{asset('storage/'.$detail->product->image)}}" alt="{{ $detail->product->name }}" width="80" class="img-thumbnail">
                                            </td>
                    ...
                    <div class="card border-start border-4 border-warning mb-4">
                        <div class="card-header bg-light fw-bold"><i class="fas fa-calculator me-2"></i>Tổng kết đơn hàng</div>
                        <div class="card-body p-3">
                            <div class="row mb-2">
                                <div class="col-sm-4 fw-bold">Tổng phụ:</div>
                                <div class="col-sm-8">{{ number_format($order->total, 0, ',', '.') }} đ</div>
                            </div>
                            <div class="row mb-2">
