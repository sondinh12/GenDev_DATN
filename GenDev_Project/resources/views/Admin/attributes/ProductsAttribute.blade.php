...
@section('content')
    <div class="card">
        ...
        <div class="card-body py-3 d-flex justify-content-between align-items-center">
            <a href="{{ route('admin.attributes.create') }}" class="btn btn-outline-primary mb-3">
                <i class="fas fa-plus me-1"></i> Thêm thuộc tính
            </a>
            <a href="{{ route('admin.attributes.trashList') }}" class="btn btn-outline-danger mb-3 float-end position-relative">
