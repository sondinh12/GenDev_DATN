            ...
            <div class="card-body">
                ...
                <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 d-flex align-items-center gap-1">
                        ...
                        <select name="product_type" id="product-type" style="width: 280px" class="form-control @error('product_type') is-invalid @enderror" onchange="toggleProductType()">
                                    ...
                                    <tbody>
                                        @foreach($product->variants as $index => $variant)
                                            <tr>
                                                ...
                                                <td><button type="button" class="btn btn-outline-danger btn-sm remove-attribute" onclick="this.closest('tr').remove()"><i class="fas fa-trash-alt"></i> Xóa</button></td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                            ...
                            @foreach($attributes as $attribute)
                                <div class="attribute-group border p-2 mb-2" data-attr-id="{{ $attribute->id }}">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <button type="button" class="btn btn-outline-danger btn-sm remove-attribute"><i class="fas fa-trash-alt"></i> Xóa</button>
                                    </div>
                                    <div class="mt-2">
