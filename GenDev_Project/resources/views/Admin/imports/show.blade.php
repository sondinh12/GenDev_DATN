...
<div class="container mt-4">
    <div class="card shadow">
        ...
        <div class="card-body">
            ...
            <div class="row mb-4">
                <div class="col-md-6"><strong>Tổng hóa đơn:</strong> {{ number_format($dtImport->total_cost) }} VNĐ</div>
                <div class="col-md-6"><strong>Ngày nhập:</strong> {{ \Carbon\Carbon::parse($dtImport->import_date)->format('d/m/Y') }}</div>
                ...
                <div class="col-md-6"><strong>Ngày cập nhật:</strong> {{ $dtImport->updated_at->format('d/m/Y H:i') }}</div>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($matchedPrice)
                                            ...
                                            <small class="text-muted">Từ ngày {{ \Carbon\Carbon::parse($matchedPrice->start_date)->format('d/m/Y') }}</small>
                                        @else
    ...
    @endif
                    ...
                    <tfoot class="table-light">
                        <tr>
                            ...
                            <td colspan="3" class="fw-bold text-danger">{{ number_format($dtImport->total_cost) }} VNĐ</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
