...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-header d-flex justify-content-between align-items-center">
            <h3 class="mb-4">Tạo phiếu nhập hàng</h3>
        </div>
        <div class="card-body table-responsive">
            <form action="{{ route('admin.imports.store') }}" method="post">
                ...
                <button type="button" class="btn btn-outline-warning mb-3" id="add-product-btn">Thêm sản phẩm</button>
                        ...
                        <div class="card-body">
                            ...
                            <div class="existing-product-section">
                                <div class="form-group">
                                    ...
                                    <select name="products[__INDEX__][product_id]"
                                        class="form-control existing-product-selector">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <input type="number" step="0.01" name="products[__INDEX__][existing_price]"
                                        class="form-control">
                                </div>
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <label>
                                        <input type="radio" name="products[__INDEX__][variant_usage_mode]"
                                            class="variant-mode-radio" value="old" checked>
                                        Chọn biến thể có sẵn
                                    </label>
                                    &nbsp;&nbsp;
                                    <label>
                                        <input type="radio" name="products[__INDEX__][variant_usage_mode]"
                                            class="variant-mode-radio" value="new">
                                        Tạo biến thể mới
                                    </label>
                                </div>
                            ...
                            <div class="new-product-section d-none mt-3">
                                ...
                                <div class="simple-fields mt-2">
                                    <div class="form-group">
                                        <label>Giá nhập:</label>
                                        <input type="number" step="0.01" name="products[__INDEX__][price]"
                                            class="form-control">
                                    </div>
                                    <div class="form-group mt-2">
                                        <label>Số lượng:</label>
                                    ...
                                    <div class="form-group mt-2">
                                        <label>Giá nhập (lịch sử nhà cung cấp - tuỳ chọn):</label>
                                        <input type="number" name="products[__INDEX__][supplier_import_price]"
                                            class="form-control" step="0.01">
                                    </div>
                                </div>
    ...
    $variantData = $existingProducts->mapWithKeys(function ($product) {
        return [
            $product->id => $product->variants->map(function ($variant) {
                $attrString = $variant->variantAttributes
                    ->map(function ($att) {
