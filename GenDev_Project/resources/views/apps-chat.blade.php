                ...
                <div class="hstack gap-3 flex-wrap">
                    <div class="user-img online align-self-center">
                        <img src="{{ URL::asset('build/images/users/avatar-2.png') }}"
                            class="rounded-circle avatar-xs avatar" alt="avatar-2">
                        ...
                        <li>
                            <div class="conversation-list">
                                <div class="chat-avatar">
                                    <img src="{{ URL::asset('build/images/users/avatar-6.png') }}" alt="avatar-2">
                                </div>
                            ...
                            <div class="conversation-list">
                                <div class="ctext-wrap">
                                    ...
                                    <p class="chat-time mb-0"><i
                                            class="mdi mdi-clock-time-eight-outline align-middle me-1"></i> 10:02</p>
                                </div>
                            </div>
                        </li>
