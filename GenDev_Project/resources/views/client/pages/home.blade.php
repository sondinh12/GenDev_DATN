                        ...
                        <section class="section-6-1-6-products-tabs">
                            ...
                            <div class="6-1-6-products-tabs">
                                <ul role="tablist" class="nav justify-content-center">
                                    <li class="nav-item"><a class="nav-link " href="#tab-30" data-toggle="tab">-30%</a>
                                    </li>
                                    <li class="nav-item"><a class="nav-link active" href="#tab-50"
                                            data-toggle="tab">-50%</a></li>
                                    <li class="nav-item"><a class="nav-link " href="#tab-70" data-toggle="tab">-70%</a>
                                    </li>
                                </ul>
                                <!-- /.nav -->
                                                    ...
                                                    @foreach ($categoryProducts[$category->id] as $product)
                                                        ...
                                                        col-12 mb-3">
                                                            <div class="card h-100 product-card border-0 shadow-lg rounded-4 position-relative overflow-hidden animate__animated animate__fadeInUp"
                                                                ...
                                                                <div
                                                                    class="card-body p-2 d-flex flex-column justify-content-between align-items-center text-center">
                                                                    <h6 class="card-title text-truncate mb-1 fw-semibold w-100"
                                                                        style="font-size:1rem;">
                                                                        <a href=""
                                                                            class="text-decoration-none text-dark">{{ $product->name }}</a>
                                                                    </h6>
                                                                    <div
                                                                        class="product-price mb-1 w-100 d-flex justify-content-center align-items-baseline gap-2">
                                                                        @if ($product->sale_price)
                                                                            <span
                                                                                class="text-danger fw-bold fs-6">{{ number_format($product->sale_price) }}đ</span>
                                                                            <small
                                                                                class="text-muted text-decoration-line-through ms-1">{{ number_format($product->price) }}đ</small>
                                                                        @else
                                                                            <span
                                                                                class="text-primary fw-bold fs-6">{{ number_format($product->price) }}đ</span>
                                                                        @endif
                                                                    </div>
                                                                    <div
                                                                    ...
                                                                    <div
                                                                        class="d-flex justify-content-between align-items-center mt-auto gap-2">
                                                                        <a href="#"
                                                                            class="btn btn-light border-0 shadow-sm rounded-circle p-2 add-to-cart"
                                                                            title="Thêm vào giỏ hàng">
                                                                            <i
                                                                                class="fas fa-shopping-cart text-primary"></i>
                                                                        </a>
                                                                        <a href="#"
                                                                            class="btn btn-light border-0 shadow-sm rounded-circle p-2 add-to-wishlist"
                                                                            title="Thêm vào yêu thích">
                                                                            <i class="fas fa-heart text-danger"></i>
                                                                        </a>
                                                                        <a href="{{ route('product.show', $product->id) }}"
                                                                            class="btn btn-light border-0 shadow-sm rounded-circle p-2 quick-view"
                                                                            title="Xem nhanh">
                                                                            <i class="fas fa-eye text-info"></i>
                                                                        </a>
                                                                        <a href=""
                                                                            class="btn btn-gradient btn-sm rounded-pill ms-auto px-3 fw-semibold">Mua
                                                                            ngay</a>
                                                                    </div>
                                                                </div>
                                                            </div>
