        ...
        <div class="techmarket-sticky-wrap">
            <div class="row">
                <div class="site-branding">
                    <a href="{{ asset('home-v1.html') }}" class="custom-logo-link" rel="home">
                                        ...
                                        <div class="tm-mega-menu">
                                            <div class="widget widget_nav_menu">
                                                <ul class="menu">
                                                    ...
                                                    <li class="menu-item">
                                                        <a href="{{ asset('home-v2.html') }}">Home v2</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a href="{{ asset('home-v3.html') }}">Home v3</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a href="{{ asset('home-v4.html') }}">Home v4</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a href="{{ asset('home-v5.html') }}">Home v5</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a href="{{ asset('home-v6.html') }}">Home v6</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a href="{{ asset('home-v7.html') }}">Home v7</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a href="{{ asset('home-v8.html') }}">Home v8</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a href="{{ asset('home-v9.html') }}">Home v9</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a href="{{ asset('home-v10.html') }}">Home v10</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a href="{{ asset('home-v11.html') }}">Home v11</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a href="{{ asset('home-v12.html') }}">Home v12</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a href="{{ asset('home-v13.html') }}">Home v13</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a href="{{ asset('home-v14.html') }}">Home v14</a>
                                                    </li>
                                                </ul>
                                                <!-- .menu -->
                                            </div>
                                            ...
                                            <div class="widget widget_nav_menu">
                                                <ul class="menu">
                                                    ...
                                                    <li class="menu-item">
                                                        <a href="{{ asset('shop-extended.html') }}">Shop Extended</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a href="{{ asset('shop-listing.html') }}">Shop Listing</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a href="{{ asset('shop-listing-large.html') }}">Shop Listing
                                                            Large</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a href="{{ asset('shop-listing-with-product-sidebar.html') }}">Shop
                                                            Listing
                                                            with Product Sidebar</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a href="{{ asset('product-category.html') }}">Categories</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a href="{{ asset('shop-right-sidebar.html') }}">Shop Right
                                                            Sidebar</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a href="{{ asset('shop-fullwidth.html') }}">Shop Full Width</a>
                                                    </li>
                                                </ul>
                                                <!-- .menu -->
                                            </div>
                                            ...
                                            <div class="widget widget_nav_menu">
                                                <ul class="menu">
                                                    ...
                                                    <li class="menu-item menu-item-object-product">
                                                        <a href="{{ asset('single-product-sidebar.html') }}">Single
                                                            Product Sidebar</a>
                                                    </li>
                                                    <li class="menu-item menu-item-object-product">
                                                        <a href="{{ asset('single-product-fullwidth.html') }}">Single
                                                            Product
                                                            Fullwidth</a>
                                                    </li>
                                                    <li class="menu-item menu-item-object-product">
                                                        <a href="{{ asset('single-product-extended.html') }}">Single
                                                            Product
                                                            Extended</a>
                                                    </li>
                                                    <li class="nav-title menu-item">
                                            ...
                                            <div class="widget widget_nav_menu">
                                                <ul class="menu">
                                                    ...
                                                    <li class="menu-item">
                                                        <a href="{{ asset('blog-fullwidth.html') }}">Blog Full Width</a>
                                                    </li>
                                                    <li class="menu-item">
                                                    ...
                                                    <li class="menu-item">
                                                        <a href="{{ asset('contact-v1.html') }}">Contact v1</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a href="{{ asset('contact-v2.html') }}">Contact v2</a>
                                                    </li>
                                                    <li class="menu-item">
            ...
            <div id="departments-menu" class="dropdown departments-menu">
                ...
                <ul id="menu-departments-menu" class="dropdown-menu yamm departments-menu-dropdown">
                    <li class="highlight menu-item animate-dropdown">
                        <a title="Value of the Day" href="{{ asset('home-v2.html') }}">Value of the Day</a>
                    </li>
                    <li class="highlight menu-item animate-dropdown">
                        <a title="Top 100 Offers" href="{{ asset('home-v3.html') }}">Top 100 Offers</a>
                    </li>
                    <li class="highlight menu-item animate-dropdown">
                        <a title="New Arrivals" href="{{ asset('home-v4.html') }}">New Arrivals</a>
                    </li>
                                                ...
                                                <div class="kc_text_block">
                                                    <ul>
                                                        ...
                                                        <li><a href="{{ asset('shop.html') }}">All Computers &amp;
                                                                Accessories</a></li>
                                                        <li><a href="{{ asset('shop.html') }}">Laptops, Desktops &amp;
                                                                Monitors</a>
                                                        </li>
                                                        <li><a href="{{ asset('shop.html') }}">Pen Drives, Hard Drives
                                                                &amp; Memory
                                                                Cards</a></li>
                                                        <li><a href="{{ asset('shop.html') }}">Printers &amp; Ink</a>
                                                        </li>
                                                        <li><a href="{{ asset('shop.html') }}">Networking &amp; Internet
                                                                Devices</a>
                                                        </li>
                                                        <li><a href="{{ asset('shop.html') }}">Computer Accessories</a>
                                                        </li>
                                                        <li><a href="{{ asset('shop.html') }}">Software</a></li>
                                                ...
                                                <div class="kc_text_block">
                                                    <ul>
                                                        ...
                                                        <li><a href="{{ asset('shop.html') }}">All Office &amp;
                                                                Stationery</a></li>
                                                        <li><a href="{{ asset('shop.html') }}">Pens &amp; Writing</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <!-- .kc_text_block -->
                            ...
                            <li class="menu-item menu-item-object-static_block animate-dropdown">
                                <div class="yamm-content">
                                    <div class="bg-yamm-content bg-yamm-content-bottom bg-yamm-content-right">
                                        <div class="kc-col-container">
                                            <div class="kc_single_image">
                                                <img src="{{ asset('assets/images/megamenu-1.jpg') }}" class=""
                                                    alt="" />
                                            </div>
                                            <!-- .kc_single_image -->
                                        </div>
                                                ...
                                                <div class="kc_text_block">
                                                    <ul>
                                                        ...
                                                        <li><a href="{{ asset('shop.html') }}">All Cameras &
                                                                Photography</a></li>
                                                        <li><a href="{{ asset('shop.html') }}">Point & Shoot Cameras</a>
                                                        </li>
                                                        <li><a href="{{ asset('shop.html') }}">Lenses</a></li>
                                                        <li><a href="{{ asset('shop.html') }}">Camera Accessories</a>
                                                        </li>
                                                        <li><a href="{{ asset('shop.html') }}">Security &
                                                                Surveillance</a></li>
                                                        <li><a href="{{ asset('shop.html') }}">Binoculars &
                                                                Telescopes</a></li>
                                                        <li><a href="{{ asset('shop.html') }}">Camcorders</a></li>
                                                        <li class="nav-divider"></li>
                                                        <li>
                                                            <a href="{{ asset('shop.html') }}">
                                                                <span class="nav-text">All Electronics</span>
                                            ...
                                            <div class="kc-col-container">
                                                <div class="kc_text_block">
                                                    <ul>
                                                        ...
                                                        <li><a href="{{ asset('shop.html') }}">All Audio & Video</a>
                                                        </li>
                                                        <li><a href="{{ asset('shop.html') }}">Headphones & Speakers</a>
                                                        </li>
                                                        <li><a href="{{ asset('shop.html') }}">Home Entertainment
                                                                Systems</a></li>
                                                        <li><a href="{{ asset('shop.html') }}">MP3 & Media Players</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <!-- .kc_text_block -->
                    ...
                    <li class="menu-item menu-item-type-custom animate-dropdown">
                        <a title="Gadgets" href="{{ asset('landing-page-v1.html') }}">Gadgets</a>
                    </li>
                    <li class="menu-item menu-item-type-custom animate-dropdown">
                        <a title="Virtual Reality" href="{{ asset('landing-page-v2.html') }}">Virtual Reality</a>
                    </li>
                </ul>
            </div>
            <!-- .departments-menu -->
            ...
            <ul id="site-header-cart" class="site-header-cart menu">
                <li class="animate-dropdown dropdown ">
                    <a href="{{ asset('cart.html') }}" class="cart-contents" data-toggle="dropdown"
                        ...
                        {{-- <span class="amount"><span class="price-label">Giỏ hàng của bạn</span>&#036;136.99</span> --}}
                    </a>
                                    ...
                                    <ul class="woocommerce-mini-cart cart_list product_list_widget ">
                                        <li class="woocommerce-mini-cart-item mini_cart_item">
                                            ...
                                            <a href="{{ asset('single-product-sidebar.html') }}">
                                                <img src="{{ asset('assets/images/products/mini-cart1.jpg') }}"
                                        ...
                                        <li class="woocommerce-mini-cart-item mini_cart_item">
                                            ...
                                            <a href="{{ asset('single-product-sidebar.html') }}">
                                                <img src="{{ asset('assets/images/products/mini-cart2.jpg') }}"
                                                    class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image"
