...
<link href="{{ asset('assets/css/colors/blue.css') }}" rel="alternate stylesheet" title="Blue color">
<link href="{{ asset('assets/css/colors/flat-green.css') }}" rel="alternate stylesheet" title="Flat Green color">
<link href="{{ asset('assets/css/colors/green.css') }}" rel="alternate stylesheet" title="Green color">
<link href="{{ asset('assets/css/colors/orange.css') }}" rel="alternate stylesheet" title="Orange color">
<link href="{{ asset('assets/css/colors/red.css') }}" rel="alternate stylesheet" title="Red color">
<link href="{{ asset('assets/css/colors/yellow.css') }}" rel="alternate stylesheet" title="Yellow color">
