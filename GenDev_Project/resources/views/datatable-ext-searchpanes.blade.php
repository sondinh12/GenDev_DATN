...
@section('css')
    ...
    <link href="{{ URL::asset('build/libs/datatables.net-searchpanes-bs5/css/searchPanes.bootstrap5.min.css') }}" rel="stylesheet"
        type="text/css" />
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Datatable searchpanes example</h4>
                </div>
                <div class="card-body">
                    <p class="text-muted"><strong>Search panes</strong> adds panes to the Datatable with the capability to
                        search the Datatable by selecting rows in the panes. This is very useful when it comes to adding a
                        more accessible searching feature and custom search capabilities.</p>
