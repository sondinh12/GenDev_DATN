...
//                     // Cho phép chọn tạo biến thể mới nếu muốn
//                     const addCustomVariantBtn = document.createElement('button');
//                     addCustomVariantBtn.className = 'btn btn-outline-secondary btn-sm mt-2';
//                     addCustomVariantBtn.type = 'button';
//                     addCustomVariantBtn.textContent = '➕ Tạo biến thể mới';
//                     addCustomVariantBtn.addEventListener('click', () => {
//                         customVariantSection.classList.remove('d-none');
//                     });

//                     if (!variantWrapper.querySelector('button')) {
//                         variantWrapper.appendChild(addCustomVariantBtn);
//                     }
//                 } else {
...
//         // Quản lý tạo thuộc tính và biến thể (cho cả sản phẩm mới và sản phẩm có sẵn)
...
//         // Quản lý nút tạo biến thể (cho cả sản phẩm mới và tạo biến thể mới cho sản phẩm cũ)
